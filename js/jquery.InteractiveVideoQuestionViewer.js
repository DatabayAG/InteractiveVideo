var InteractiveVideoQuestionViewer = (function (scope) {
	...
	pro.showFeedback = function(feedback) {
		...
		{
   modal.append('<div class="learning_recommendation_link">' + scope.InteractiveVideo.lang.more_information + ': <span class="feedback_link_more">' + '<img class="feedback_link_more_icon" src="' + feedback.feedback_icon + '"/>' + feedback.feedback_link + '</span></div>');
		}
	};
